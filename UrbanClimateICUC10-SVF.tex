...
Of these possible sky clusters, only clusters with number of pixels greater than a percentage ($Skyreq$) of all pixels in the image were then marked as sky regions. Results shown in Figure \ref{fig:kmeansresults}. 

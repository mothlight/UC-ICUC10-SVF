...
\begin{tabular}{ l l l}
\textbf{Technique designations} & \textbf{Technique} & \textbf{Variations}  \\ \hline
...
K-means  & K-means clustering and HSL color filtering algorithm developed by the authors &3 \\
Sobel/flood-fill  & \cite{Middel2018}'s Sobel operator/flood-fill algorithm &1 \\
\hline
\end{tabular}
\end{table}
...
\subsubsection{Sobel operator/hybrid probability model}\label{sec:prob}
...
\begin{figure}
\centering    
\textbf{a)}\includegraphics[scale=0.20]{Images/2/panorama-JtVHmEl7WCiz1xJ0bcJpBg-1_Sobel.png} 
\textbf{b)}\includegraphics[scale=0.20]{Images/2/panorama-JtVHmEl7WCiz1xJ0bcJpBg-1_Sobel_prob.png} 
\textbf{c)}\includegraphics[scale=0.20]{Images/2/panorama-JtVHmEl7WCiz1xJ0bcJpBg-1_Sobel_95_marked.png} 
\textbf{d)}\includegraphics[scale=0.20]{Images/2/panorama-JtVHmEl7WCiz1xJ0bcJpBg-1_Sobel_90_marked.png} 
\textbf{e)}\includegraphics[scale=0.20]{Images/2/panorama-JtVHmEl7WCiz1xJ0bcJpBg-1_Sobel_80_marked.png} 
\textbf{f)}\includegraphics[scale=0.20]{Images/2/panorama-JtVHmEl7WCiz1xJ0bcJpBg-1_Sobel_70_marked.png} 
\textbf{g)}\includegraphics[scale=0.20]{Images/2/panorama-JtVHmEl7WCiz1xJ0bcJpBg-1_Sobel_60_marked.png} 
\textbf{h)}\includegraphics[scale=0.20]{Images/2/panorama-JtVHmEl7WCiz1xJ0bcJpBg-1_Sobel_50_marked.png} 
...
\begin{figure}
\centering    
%\textbf{a)}\includegraphics[scale=0.25]{Images/2/panorama-JtVHmEl7WCiz1xJ0bcJpBg-1_cropped.png} 
\textbf{a)}\includegraphics[scale=0.25]{Images/2/panorama-JtVHmEl7WCiz1xJ0bcJpBg-1_seg.png} 
\textbf{b)}\includegraphics[scale=0.25]{Images/2/panorama-JtVHmEl7WCiz1xJ0bcJpBg-1_ms_sky_mark.png} 
\caption{\bf Results of mean shift (Mean\_5\_7\_210) showing a) mean shifted image and b) final marked image.}    
...
\caption{\bf  Results of K-means clustering (K-mean\_6) and HSL filtering, showing a) K-means clustered image, b) HSL intermediate image, and c) final marked image.}    

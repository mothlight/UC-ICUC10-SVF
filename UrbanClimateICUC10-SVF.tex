...
Four different variations of the input parameters were used, determined experimentally through a sensitivity test to work across the widest variety of images. The technique designations and parameters are detailed in Table \ref{tab:techniques2}. As can be seen in Figure \ref{fig:meantypes}, in an effort to shift the entire sky to a single colour, images with multi-coloured clouds are more accurately segmented when the radius and density parameters are increased (in Figures \ref{fig:meantypes}a to d). However, this can have the effect of creating false positives in other images, for example as buildings are increasingly segmented into the sky (in Figures \ref{fig:meantypes}e to h). Mean shift is applied to each image with the chosen set of parameters and pixels of the most common colour (in the top half of the image) are marked as sky. Example results are shown in Figure \ref{fig:meanresults}.
...
\begin{figure}
\centering    
%\textbf{f)}\includegraphics[scale=0.10]{Images/mean/4880_orig.png} 
...
%\textbf{a)}\includegraphics[scale=0.10]{Images/mean/0070_orig.png} 
\textbf{e)}\includegraphics[scale=0.08]{Images/mean/0070_3_6_100.png} 
\textbf{f)}\includegraphics[scale=0.08]{Images/mean/0070_7_6_100.png} 
\textbf{g)}\includegraphics[scale=0.08]{Images/mean/0070_5_7_210.png} 
\textbf{h)}\includegraphics[scale=0.08]{Images/mean/0070_7_8_300.png} 


 
\caption{\bf Comparison outputs of intermediate mean shift processing with varying parameters, showing a) Mean\_3\_6\_100, b) Mean\_7\_6\_100, c) Mean\_5\_7\_210, d) Mean\_7\_8\_300, 
 e) Mean\_3\_6\_100, f) Mean\_7\_6\_100, g) Mean\_5\_7\_210, and h) Mean\_7\_8\_300}    
 \label{fig:meantypes}  
\end{figure} 
...
\textbf{Designation} & \textbf{Clusters} & \textbf{Skyreq}&\textbf{H$_{uplimit}$}&\textbf{H$_{downlimit}$} & \textbf{L$_{lightness}$} & \textbf{L$_{grey}$}& \textbf{S$_{grey}$} \\ \hline
